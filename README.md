...
| 10 | `《计算机是怎样跑起来的》` |  暂定 | 暂定 | 0% |
| 11 | `《编程之法：面试和算法心得》` |  暂定 | 暂定 | 0% |
| 12 | `《程序员修炼之道——从小工到专家》` |  暂定 | 暂定 | 0% |
| 13 | `《大型网站技术架构》` |  暂定 | 暂定 | 0% |
| 14 | `《编程珠玑》` |  暂定 | 暂定 | 0% |
| 15 | `《硅谷之火》` |  暂定 | 暂定 | 0% |
| 16 | `《白帽子讲Web安全》` |  暂定 | 暂定 | 0% |
| 17 | `《程序员的英语》` |  暂定 | 暂定 | 0% |
| 18 | `《了不起到Node.js》` |  暂定 | 暂定 | 0% |
| 19 | `《黑客与画家》` |  暂定 | 暂定 | 0% |
| 20 | `《丑陋的中国人》` |  暂定 | 暂定 | 0% |
...
- 11.10，《JavaScript高级程序设计 第3版》打卡[第六天](https://github.com/PDKSophia/read-booklist/blob/master/JavaScript%E9%AB%98%E7%BA%A7%E7%BC%96%E7%A8%8B%E8%AE%BE%E8%AE%A1/play-card-6.md)， 知识点: [Document类型]()、[Element类型]()